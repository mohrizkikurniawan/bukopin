...
* <Rating>-181</Rating>
*-----------------------------------------------------------------------------
    SUBROUTINE ATI.VIN.DEL.FAVORITE
*-----------------------------------------------------------------------------
* Developer Name     : Dhio Faizar Wahyudi
* Development Date   : 20180314
* Description        : Routine for delete favorite
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
	...
	FIND Y.ATI.TH.FAVOURITE.CONTACT.ID.NO IN Y.ATI.TH.FAVOURITE.CONTACT.ID.NO.SAVE SETTING Y.POSF, Y.POSV, Y.POSS THEN
		DEL Y.ATI.TH.FAVOURITE.CONTACT.ID.NO.SAVE<1, Y.POSV>
		DEL Y.ATI.TH.FAVOURITE.CONTACT.NAME.SAVE<1, Y.POSV>
	END
